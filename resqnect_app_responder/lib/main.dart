...
import 'responder/dashboard_responder.dart'; // Changed from user/dashboard_users.dart

void main() {
  runApp(
    MaterialApp(
      debugShowCheckedModeBanner: false,
      home: DashboardResponder(), // Changed to use responder dashboard
    ),
  );
}
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const DashboardResponder(), // Changed to DashboardResponder
                              ),
                            );
                          },
                          child: const Text(
